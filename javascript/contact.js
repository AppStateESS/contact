...
/* global $, social_urls, active_tab, thumbnail_map, google, CKEDITOR */
...
function ContactTab() {
  ...
  this.changeTab = function () {
    ...
    var class_tab = '.' + this.active + '-tab a'
...
function ContactSocial() {
  ...
  this.start = function () {
    ...
    first_tab.children('a.nav-link').addClass('active')
  ...
  this.populateForm = function () {
    $('#social-icon').html(
      '<i class="' + this.current_icon + ' fa-5x"></i>'
    )
  ...
  this.readyTabs = function () {
    ...
    $('.social-pick-tab').click(function () {
      ...
      $this.setActiveTab($(this).children('a'))
      $this.populateForm()
    })
  }
  ...
  this.setActiveTab = function (selected) {
    $('.social-pick-tab a').removeClass('active')
